...
<body>
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="index.html">Trang chủ</a> / <span>Chi tiết tin tức</span></h3>
			</div>
		</div>
	<!--banner-->
		<!--content-->
					...
					<div class="mail-w3ls">
						<div class="container">
							...
							<div class="col-md-3">
								...
								<h2 class="title-relateNews">Tin liên quan</h2>
								<ul class="img-related-news">
									@foreach($lienquan as $k => $item)
                                     @php 
